...
SWIGINTERN std::vector< MAF::IMediaPipelineFactoryPlugin * > *new_std_vector_Sl_MAF_IMediaPipelineFactoryPlugin_Sm__Sg___SWIG_2(int capacity){
        std::vector< MAF::IMediaPipelineFactoryPlugin * >* pv = 0;
        if (capacity >= 0) {
          pv = new std::vector< MAF::IMediaPipelineFactoryPlugin * >();
          pv->reserve(capacity);
       } else {
          throw std::out_of_range("capacity");
       }
...
SWIGINTERN MAF::IMediaPipelineFactoryPlugin *std_vector_Sl_MAF_IMediaPipelineFactoryPlugin_Sm__Sg__getitemcopy(std::vector< MAF::IMediaPipelineFactoryPlugin * > *self,int index){
        if (index>=0 && index<(int)self->size())
          return (*self)[index];
        else
          throw std::out_of_range("index");
      }
SWIGINTERN std::vector< MAF::IMediaPipelineFactoryPlugin * >::value_type const &std_vector_Sl_MAF_IMediaPipelineFactoryPlugin_Sm__Sg__getitem(std::vector< MAF::IMediaPipelineFactoryPlugin * > *self,int index){
        if (index>=0 && index<(int)self->size())
          return (*self)[index];
        else
          throw std::out_of_range("index");
      }
SWIGINTERN void std_vector_Sl_MAF_IMediaPipelineFactoryPlugin_Sm__Sg__setitem(std::vector< MAF::IMediaPipelineFactoryPlugin * > *self,int index,MAF::IMediaPipelineFactoryPlugin *const &val){
        if (index>=0 && index<(int)self->size())
          (*self)[index] = val;
        else
          throw std::out_of_range("index");
      }
SWIGINTERN void std_vector_Sl_MAF_IMediaPipelineFactoryPlugin_Sm__Sg__AddRange(std::vector< MAF::IMediaPipelineFactoryPlugin * > *self,std::vector< MAF::IMediaPipelineFactoryPlugin * > const &values){
        self->insert(self->end(), values.begin(), values.end());
      }
SWIGINTERN std::vector< MAF::IMediaPipelineFactoryPlugin * > *std_vector_Sl_MAF_IMediaPipelineFactoryPlugin_Sm__Sg__GetRange(std::vector< MAF::IMediaPipelineFactoryPlugin * > *self,int index,int count){
        if (index < 0)
          throw std::out_of_range("index");
        if (count < 0)
          throw std::out_of_range("count");
        if (index >= (int)self->size()+1 || index+count > (int)self->size())
          throw std::invalid_argument("invalid range");
        return new std::vector< MAF::IMediaPipelineFactoryPlugin * >(self->begin()+index, self->begin()+index+count);
      }
SWIGINTERN void std_vector_Sl_MAF_IMediaPipelineFactoryPlugin_Sm__Sg__Insert(std::vector< MAF::IMediaPipelineFactoryPlugin * > *self,int index,MAF::IMediaPipelineFactoryPlugin *const &x){
        if (index>=0 && index<(int)self->size()+1)
          self->insert(self->begin()+index, x);
        else
          throw std::out_of_range("index");
      }
SWIGINTERN void std_vector_Sl_MAF_IMediaPipelineFactoryPlugin_Sm__Sg__InsertRange(std::vector< MAF::IMediaPipelineFactoryPlugin * > *self,int index,std::vector< MAF::IMediaPipelineFactoryPlugin * > const &values){
        if (index>=0 && index<(int)self->size()+1)
          self->insert(self->begin()+index, values.begin(), values.end());
        else
          throw std::out_of_range("index");
      }
SWIGINTERN void std_vector_Sl_MAF_IMediaPipelineFactoryPlugin_Sm__Sg__RemoveAt(std::vector< MAF::IMediaPipelineFactoryPlugin * > *self,int index){
        if (index>=0 && index<(int)self->size())
          self->erase(self->begin() + index);
        else
          throw std::out_of_range("index");
      }
SWIGINTERN void std_vector_Sl_MAF_IMediaPipelineFactoryPlugin_Sm__Sg__RemoveRange(std::vector< MAF::IMediaPipelineFactoryPlugin * > *self,int index,int count){
        if (index < 0)
          throw std::out_of_range("index");
        if (count < 0)
          throw std::out_of_range("count");
...
SWIGINTERN std::vector< MAF::IMediaPipelineFactoryPlugin * > *std_vector_Sl_MAF_IMediaPipelineFactoryPlugin_Sm__Sg__Repeat(MAF::IMediaPipelineFactoryPlugin *const &value,int count){
        if (count < 0)
          throw std::out_of_range("count");
        return new std::vector< MAF::IMediaPipelineFactoryPlugin * >(count, value);
      }
SWIGINTERN void std_vector_Sl_MAF_IMediaPipelineFactoryPlugin_Sm__Sg__Reverse__SWIG_0(std::vector< MAF::IMediaPipelineFactoryPlugin * > *self){
        std::reverse(self->begin(), self->end());
      }
SWIGINTERN void std_vector_Sl_MAF_IMediaPipelineFactoryPlugin_Sm__Sg__Reverse__SWIG_1(std::vector< MAF::IMediaPipelineFactoryPlugin * > *self,int index,int count){
        if (index < 0)
          throw std::out_of_range("index");
        if (count < 0)
          throw std::out_of_range("count");
...
SWIGINTERN void std_vector_Sl_MAF_IMediaPipelineFactoryPlugin_Sm__Sg__SetRange(std::vector< MAF::IMediaPipelineFactoryPlugin * > *self,int index,std::vector< MAF::IMediaPipelineFactoryPlugin * > const &values){
        if (index < 0)
          throw std::out_of_range("index");
        if (index+values.size() > self->size())
          throw std::out_of_range("index");
...
SWIGINTERN bool std_vector_Sl_MAF_IMediaPipelineFactoryPlugin_Sm__Sg__Contains(std::vector< MAF::IMediaPipelineFactoryPlugin * > *self,MAF::IMediaPipelineFactoryPlugin *const &value){
        return std::find(self->begin(), self->end(), value) != self->end();
      }
SWIGINTERN int std_vector_Sl_MAF_IMediaPipelineFactoryPlugin_Sm__Sg__IndexOf(std::vector< MAF::IMediaPipelineFactoryPlugin * > *self,MAF::IMediaPipelineFactoryPlugin *const &value){
        int index = -1;
        std::vector< MAF::IMediaPipelineFactoryPlugin * >::iterator it = std::find(self->begin(), self->end(), value);
        if (it != self->end())
          index = (int)(it - self->begin());
        return index;
      }
SWIGINTERN int std_vector_Sl_MAF_IMediaPipelineFactoryPlugin_Sm__Sg__LastIndexOf(std::vector< MAF::IMediaPipelineFactoryPlugin * > *self,MAF::IMediaPipelineFactoryPlugin *const &value){
        int index = -1;
        std::vector< MAF::IMediaPipelineFactoryPlugin * >::reverse_iterator rit = std::find(self->rbegin(), self->rend(), value);
        if (rit != self->rend())
          index = (int)(self->rend() - 1 - rit);
        return index;
      }
SWIGINTERN bool std_vector_Sl_MAF_IMediaPipelineFactoryPlugin_Sm__Sg__Remove(std::vector< MAF::IMediaPipelineFactoryPlugin * > *self,MAF::IMediaPipelineFactoryPlugin *const &value){
        std::vector< MAF::IMediaPipelineFactoryPlugin * >::iterator it = std::find(self->begin(), self->end(), value);
        if (it != self->end()) {
          self->erase(it);
          return true;
...
SWIGEXPORT unsigned long SWIGSTDCALL CSharp_maf_BufferInfoArray_size(void * jarg1) {
...
SWIGEXPORT unsigned long SWIGSTDCALL CSharp_maf_BufferInfoArray_capacity(void * jarg1) {
  unsigned long jresult ;
  std::vector< MAF::BufferInfo > *arg1 = (std::vector< MAF::BufferInfo > *) 0 ;
  std::vector< MAF::BufferInfo >::size_type result;
...
SWIGEXPORT void SWIGSTDCALL CSharp_maf_BufferInfoArray_reserve(void * jarg1, unsigned long jarg2) {
  std::vector< MAF::BufferInfo > *arg1 = (std::vector< MAF::BufferInfo > *) 0 ;
...
SWIGEXPORT unsigned long SWIGSTDCALL CSharp_maf_BufferInfoHeaderArray_size(void * jarg1) {
  unsigned long jresult ;
  std::vector< MAF::BufferInfoHeader > *arg1 = (std::vector< MAF::BufferInfoHeader > *) 0 ;
...
SWIGEXPORT unsigned long SWIGSTDCALL CSharp_maf_BufferInfoHeaderArray_capacity(void * jarg1) {
  unsigned long jresult ;
  std::vector< MAF::BufferInfoHeader > *arg1 = (std::vector< MAF::BufferInfoHeader > *) 0 ;
  std::vector< MAF::BufferInfoHeader >::size_type result;
...
SWIGEXPORT void SWIGSTDCALL CSharp_maf_BufferInfoHeaderArray_reserve(void * jarg1, unsigned long jarg2) {
  std::vector< MAF::BufferInfoHeader > *arg1 = (std::vector< MAF::BufferInfoHeader > *) 0 ;
...
SWIGEXPORT unsigned long SWIGSTDCALL CSharp_maf_MediaLocationArray_size(void * jarg1) {
  unsigned long jresult ;
  std::vector< MAF::AlternativeLocation > *arg1 = (std::vector< MAF::AlternativeLocation > *) 0 ;
...
SWIGEXPORT unsigned long SWIGSTDCALL CSharp_maf_MediaLocationArray_capacity(void * jarg1) {
  unsigned long jresult ;
  std::vector< MAF::AlternativeLocation > *arg1 = (std::vector< MAF::AlternativeLocation > *) 0 ;
  std::vector< MAF::AlternativeLocation >::size_type result;
...
SWIGEXPORT void SWIGSTDCALL CSharp_maf_MediaLocationArray_reserve(void * jarg1, unsigned long jarg2) {
  std::vector< MAF::AlternativeLocation > *arg1 = (std::vector< MAF::AlternativeLocation > *) 0 ;
...
SWIGEXPORT unsigned long SWIGSTDCALL CSharp_maf_FrameArray_size(void * jarg1) {
  unsigned long jresult ;
  std::vector< MAF::Frame > *arg1 = (std::vector< MAF::Frame > *) 0 ;
...
SWIGEXPORT unsigned long SWIGSTDCALL CSharp_maf_FrameArray_capacity(void * jarg1) {
  unsigned long jresult ;
  std::vector< MAF::Frame > *arg1 = (std::vector< MAF::Frame > *) 0 ;
  std::vector< MAF::Frame >::size_type result;
...
SWIGEXPORT void SWIGSTDCALL CSharp_maf_FrameArray_reserve(void * jarg1, unsigned long jarg2) {
  std::vector< MAF::Frame > *arg1 = (std::vector< MAF::Frame > *) 0 ;
...
SWIGEXPORT unsigned long SWIGSTDCALL CSharp_maf_TrackArray_size(void * jarg1) {
  unsigned long jresult ;
  std::vector< MAF::Track > *arg1 = (std::vector< MAF::Track > *) 0 ;
...
SWIGEXPORT unsigned long SWIGSTDCALL CSharp_maf_TrackArray_capacity(void * jarg1) {
  unsigned long jresult ;
  std::vector< MAF::Track > *arg1 = (std::vector< MAF::Track > *) 0 ;
  std::vector< MAF::Track >::size_type result;
...
SWIGEXPORT void SWIGSTDCALL CSharp_maf_TrackArray_reserve(void * jarg1, unsigned long jarg2) {
  std::vector< MAF::Track > *arg1 = (std::vector< MAF::Track > *) 0 ;
...
SWIGEXPORT void SWIGSTDCALL CSharp_maf_PluginArray_Clear(void * jarg1) {
  std::vector< MAF::IMediaPipelineFactoryPlugin * > *arg1 = (std::vector< MAF::IMediaPipelineFactoryPlugin * > *) 0 ;
  
  arg1 = (std::vector< MAF::IMediaPipelineFactoryPlugin * > *)jarg1; 
  (arg1)->clear();
}


SWIGEXPORT void SWIGSTDCALL CSharp_maf_PluginArray_Add(void * jarg1, void * jarg2) {
  std::vector< MAF::IMediaPipelineFactoryPlugin * > *arg1 = (std::vector< MAF::IMediaPipelineFactoryPlugin * > *) 0 ;
  MAF::IMediaPipelineFactoryPlugin **arg2 = 0 ;
  MAF::IMediaPipelineFactoryPlugin *temp2 = 0 ;
  
  arg1 = (std::vector< MAF::IMediaPipelineFactoryPlugin * > *)jarg1; 
  temp2 = (MAF::IMediaPipelineFactoryPlugin *)jarg2;
  arg2 = (MAF::IMediaPipelineFactoryPlugin **)&temp2; 
  (arg1)->push_back((MAF::IMediaPipelineFactoryPlugin *const &)*arg2);
}


SWIGEXPORT unsigned long SWIGSTDCALL CSharp_maf_PluginArray_size(void * jarg1) {
  unsigned long jresult ;
  std::vector< MAF::IMediaPipelineFactoryPlugin * > *arg1 = (std::vector< MAF::IMediaPipelineFactoryPlugin * > *) 0 ;
  std::vector< MAF::IMediaPipelineFactoryPlugin * >::size_type result;
  
  arg1 = (std::vector< MAF::IMediaPipelineFactoryPlugin * > *)jarg1; 
  result = ((std::vector< MAF::IMediaPipelineFactoryPlugin * > const *)arg1)->size();
  jresult = (unsigned long)result; 
  return jresult;
}


SWIGEXPORT unsigned long SWIGSTDCALL CSharp_maf_PluginArray_capacity(void * jarg1) {
  unsigned long jresult ;
  std::vector< MAF::IMediaPipelineFactoryPlugin * > *arg1 = (std::vector< MAF::IMediaPipelineFactoryPlugin * > *) 0 ;
  std::vector< MAF::IMediaPipelineFactoryPlugin * >::size_type result;
  
  arg1 = (std::vector< MAF::IMediaPipelineFactoryPlugin * > *)jarg1; 
  result = ((std::vector< MAF::IMediaPipelineFactoryPlugin * > const *)arg1)->capacity();
  jresult = (unsigned long)result; 
  return jresult;
}


SWIGEXPORT void SWIGSTDCALL CSharp_maf_PluginArray_reserve(void * jarg1, unsigned long jarg2) {
  std::vector< MAF::IMediaPipelineFactoryPlugin * > *arg1 = (std::vector< MAF::IMediaPipelineFactoryPlugin * > *) 0 ;
  std::vector< MAF::IMediaPipelineFactoryPlugin * >::size_type arg2 ;
  
  arg1 = (std::vector< MAF::IMediaPipelineFactoryPlugin * > *)jarg1; 
  arg2 = (std::vector< MAF::IMediaPipelineFactoryPlugin * >::size_type)jarg2; 
  (arg1)->reserve(arg2);
}


SWIGEXPORT void * SWIGSTDCALL CSharp_maf_new_PluginArray__SWIG_0() {
  void * jresult ;
  std::vector< MAF::IMediaPipelineFactoryPlugin * > *result = 0 ;
  
  result = (std::vector< MAF::IMediaPipelineFactoryPlugin * > *)new std::vector< MAF::IMediaPipelineFactoryPlugin * >();
  jresult = (void *)result; 
  return jresult;
}


SWIGEXPORT void * SWIGSTDCALL CSharp_maf_new_PluginArray__SWIG_1(void * jarg1) {
  void * jresult ;
  std::vector< MAF::IMediaPipelineFactoryPlugin * > *arg1 = 0 ;
  std::vector< MAF::IMediaPipelineFactoryPlugin * > *result = 0 ;
  
  arg1 = (std::vector< MAF::IMediaPipelineFactoryPlugin * > *)jarg1;
  if (!arg1) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentNullException, "std::vector< MAF::IMediaPipelineFactoryPlugin * > const & is null", 0);
    return 0;
  } 
  result = (std::vector< MAF::IMediaPipelineFactoryPlugin * > *)new std::vector< MAF::IMediaPipelineFactoryPlugin * >((std::vector< MAF::IMediaPipelineFactoryPlugin * > const &)*arg1);
  jresult = (void *)result; 
  return jresult;
}


SWIGEXPORT void * SWIGSTDCALL CSharp_maf_new_PluginArray__SWIG_2(int jarg1) {
  void * jresult ;
  int arg1 ;
  std::vector< MAF::IMediaPipelineFactoryPlugin * > *result = 0 ;
  ...
  arg1 = (int)jarg1; 
  try {
    result = (std::vector< MAF::IMediaPipelineFactoryPlugin * > *)new_std_vector_Sl_MAF_IMediaPipelineFactoryPlugin_Sm__Sg___SWIG_2(arg1);
  } catch(std::out_of_range &_e) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentOutOfRangeException, 0, (&_e)->what());
    return 0;
  }
...
SWIGEXPORT void * SWIGSTDCALL CSharp_maf_PluginArray_getitemcopy(void * jarg1, int jarg2) {
  void * jresult ;
  std::vector< MAF::IMediaPipelineFactoryPlugin * > *arg1 = (std::vector< MAF::IMediaPipelineFactoryPlugin * > *) 0 ;
  int arg2 ;
  MAF::IMediaPipelineFactoryPlugin *result = 0 ;
  
  arg1 = (std::vector< MAF::IMediaPipelineFactoryPlugin * > *)jarg1; 
  arg2 = (int)jarg2; 
  try {
    result = (MAF::IMediaPipelineFactoryPlugin *)std_vector_Sl_MAF_IMediaPipelineFactoryPlugin_Sm__Sg__getitemcopy(arg1,arg2);
  } catch(std::out_of_range &_e) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentOutOfRangeException, 0, (&_e)->what());
    return 0;
  }
...
SWIGEXPORT void * SWIGSTDCALL CSharp_maf_PluginArray_getitem(void * jarg1, int jarg2) {
  void * jresult ;
  std::vector< MAF::IMediaPipelineFactoryPlugin * > *arg1 = (std::vector< MAF::IMediaPipelineFactoryPlugin * > *) 0 ;
  int arg2 ;
  std::vector< MAF::IMediaPipelineFactoryPlugin * >::value_type *result = 0 ;
  
  arg1 = (std::vector< MAF::IMediaPipelineFactoryPlugin * > *)jarg1; 
  arg2 = (int)jarg2; 
  try {
    result = (std::vector< MAF::IMediaPipelineFactoryPlugin * >::value_type *) &std_vector_Sl_MAF_IMediaPipelineFactoryPlugin_Sm__Sg__getitem(arg1,arg2);
  } catch(std::out_of_range &_e) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentOutOfRangeException, 0, (&_e)->what());
    return 0;
  }
...
SWIGEXPORT void SWIGSTDCALL CSharp_maf_PluginArray_setitem(void * jarg1, int jarg2, void * jarg3) {
  std::vector< MAF::IMediaPipelineFactoryPlugin * > *arg1 = (std::vector< MAF::IMediaPipelineFactoryPlugin * > *) 0 ;
  int arg2 ;
  MAF::IMediaPipelineFactoryPlugin **arg3 = 0 ;
  MAF::IMediaPipelineFactoryPlugin *temp3 = 0 ;
  
  arg1 = (std::vector< MAF::IMediaPipelineFactoryPlugin * > *)jarg1; 
  arg2 = (int)jarg2; 
  temp3 = (MAF::IMediaPipelineFactoryPlugin *)jarg3;
  arg3 = (MAF::IMediaPipelineFactoryPlugin **)&temp3; 
  try {
    std_vector_Sl_MAF_IMediaPipelineFactoryPlugin_Sm__Sg__setitem(arg1,arg2,(MAF::IMediaPipelineFactoryPlugin *const &)*arg3);
  } catch(std::out_of_range &_e) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentOutOfRangeException, 0, (&_e)->what());
    return ;
  }
...
SWIGEXPORT void SWIGSTDCALL CSharp_maf_PluginArray_AddRange(void * jarg1, void * jarg2) {
  std::vector< MAF::IMediaPipelineFactoryPlugin * > *arg1 = (std::vector< MAF::IMediaPipelineFactoryPlugin * > *) 0 ;
  std::vector< MAF::IMediaPipelineFactoryPlugin * > *arg2 = 0 ;
  
  arg1 = (std::vector< MAF::IMediaPipelineFactoryPlugin * > *)jarg1; 
  arg2 = (std::vector< MAF::IMediaPipelineFactoryPlugin * > *)jarg2;
  if (!arg2) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentNullException, "std::vector< MAF::IMediaPipelineFactoryPlugin * > const & is null", 0);
    return ;
  } 
  std_vector_Sl_MAF_IMediaPipelineFactoryPlugin_Sm__Sg__AddRange(arg1,(std::vector< MAF::IMediaPipelineFactoryPlugin * > const &)*arg2);
}


SWIGEXPORT void * SWIGSTDCALL CSharp_maf_PluginArray_GetRange(void * jarg1, int jarg2, int jarg3) {
  void * jresult ;
  std::vector< MAF::IMediaPipelineFactoryPlugin * > *arg1 = (std::vector< MAF::IMediaPipelineFactoryPlugin * > *) 0 ;
  int arg2 ;
  int arg3 ;
  ...
  arg3 = (int)jarg3; 
  try {
    result = (std::vector< MAF::IMediaPipelineFactoryPlugin * > *)std_vector_Sl_MAF_IMediaPipelineFactoryPlugin_Sm__Sg__GetRange(arg1,arg2,arg3);
  } catch(std::out_of_range &_e) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentOutOfRangeException, 0, (&_e)->what());
    return 0;
  } catch(std::invalid_argument &_e) {
...
SWIGEXPORT void SWIGSTDCALL CSharp_maf_PluginArray_Insert(void * jarg1, int jarg2, void * jarg3) {
  std::vector< MAF::IMediaPipelineFactoryPlugin * > *arg1 = (std::vector< MAF::IMediaPipelineFactoryPlugin * > *) 0 ;
  int arg2 ;
  MAF::IMediaPipelineFactoryPlugin **arg3 = 0 ;
  MAF::IMediaPipelineFactoryPlugin *temp3 = 0 ;
  ...
  arg3 = (MAF::IMediaPipelineFactoryPlugin **)&temp3; 
  try {
    std_vector_Sl_MAF_IMediaPipelineFactoryPlugin_Sm__Sg__Insert(arg1,arg2,(MAF::IMediaPipelineFactoryPlugin *const &)*arg3);
  } catch(std::out_of_range &_e) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentOutOfRangeException, 0, (&_e)->what());
    return ;
  }
...
SWIGEXPORT void SWIGSTDCALL CSharp_maf_PluginArray_InsertRange(void * jarg1, int jarg2, void * jarg3) {
  std::vector< MAF::IMediaPipelineFactoryPlugin * > *arg1 = (std::vector< MAF::IMediaPipelineFactoryPlugin * > *) 0 ;
  int arg2 ;
  std::vector< MAF::IMediaPipelineFactoryPlugin * > *arg3 = 0 ;
  
  arg1 = (std::vector< MAF::IMediaPipelineFactoryPlugin * > *)jarg1; 
  arg2 = (int)jarg2; 
  arg3 = (std::vector< MAF::IMediaPipelineFactoryPlugin * > *)jarg3;
  if (!arg3) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentNullException, "std::vector< MAF::IMediaPipelineFactoryPlugin * > const & is null", 0);
    return ;
  } 
  try {
    std_vector_Sl_MAF_IMediaPipelineFactoryPlugin_Sm__Sg__InsertRange(arg1,arg2,(std::vector< MAF::IMediaPipelineFactoryPlugin * > const &)*arg3);
  } catch(std::out_of_range &_e) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentOutOfRangeException, 0, (&_e)->what());
    return ;
  }
...
SWIGEXPORT void SWIGSTDCALL CSharp_maf_PluginArray_RemoveAt(void * jarg1, int jarg2) {
  std::vector< MAF::IMediaPipelineFactoryPlugin * > *arg1 = (std::vector< MAF::IMediaPipelineFactoryPlugin * > *) 0 ;
  int arg2 ;
  ...
  arg2 = (int)jarg2; 
  try {
    std_vector_Sl_MAF_IMediaPipelineFactoryPlugin_Sm__Sg__RemoveAt(arg1,arg2);
  } catch(std::out_of_range &_e) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentOutOfRangeException, 0, (&_e)->what());
    return ;
  }
...
SWIGEXPORT void SWIGSTDCALL CSharp_maf_PluginArray_RemoveRange(void * jarg1, int jarg2, int jarg3) {
  std::vector< MAF::IMediaPipelineFactoryPlugin * > *arg1 = (std::vector< MAF::IMediaPipelineFactoryPlugin * > *) 0 ;
  int arg2 ;
  int arg3 ;
  ...
  arg3 = (int)jarg3; 
  try {
    std_vector_Sl_MAF_IMediaPipelineFactoryPlugin_Sm__Sg__RemoveRange(arg1,arg2,arg3);
  } catch(std::out_of_range &_e) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentOutOfRangeException, 0, (&_e)->what());
    return ;
  } catch(std::invalid_argument &_e) {
...
SWIGEXPORT void * SWIGSTDCALL CSharp_maf_PluginArray_Repeat(void * jarg1, int jarg2) {
  void * jresult ;
  MAF::IMediaPipelineFactoryPlugin **arg1 = 0 ;
  int arg2 ;
  MAF::IMediaPipelineFactoryPlugin *temp1 = 0 ;
  std::vector< MAF::IMediaPipelineFactoryPlugin * > *result = 0 ;
  
  temp1 = (MAF::IMediaPipelineFactoryPlugin *)jarg1;
  arg1 = (MAF::IMediaPipelineFactoryPlugin **)&temp1; 
  arg2 = (int)jarg2; 
  try {
    result = (std::vector< MAF::IMediaPipelineFactoryPlugin * > *)std_vector_Sl_MAF_IMediaPipelineFactoryPlugin_Sm__Sg__Repeat((MAF::IMediaPipelineFactoryPlugin *const &)*arg1,arg2);
  } catch(std::out_of_range &_e) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentOutOfRangeException, 0, (&_e)->what());
    return 0;
  }
...
SWIGEXPORT void SWIGSTDCALL CSharp_maf_PluginArray_Reverse__SWIG_0(void * jarg1) {
  std::vector< MAF::IMediaPipelineFactoryPlugin * > *arg1 = (std::vector< MAF::IMediaPipelineFactoryPlugin * > *) 0 ;
  
  arg1 = (std::vector< MAF::IMediaPipelineFactoryPlugin * > *)jarg1; 
  std_vector_Sl_MAF_IMediaPipelineFactoryPlugin_Sm__Sg__Reverse__SWIG_0(arg1);
}


SWIGEXPORT void SWIGSTDCALL CSharp_maf_PluginArray_Reverse__SWIG_1(void * jarg1, int jarg2, int jarg3) {
  std::vector< MAF::IMediaPipelineFactoryPlugin * > *arg1 = (std::vector< MAF::IMediaPipelineFactoryPlugin * > *) 0 ;
  int arg2 ;
  int arg3 ;
  ...
  arg3 = (int)jarg3; 
  try {
    std_vector_Sl_MAF_IMediaPipelineFactoryPlugin_Sm__Sg__Reverse__SWIG_1(arg1,arg2,arg3);
  } catch(std::out_of_range &_e) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentOutOfRangeException, 0, (&_e)->what());
    return ;
  } catch(std::invalid_argument &_e) {
...
SWIGEXPORT void SWIGSTDCALL CSharp_maf_PluginArray_SetRange(void * jarg1, int jarg2, void * jarg3) {
  std::vector< MAF::IMediaPipelineFactoryPlugin * > *arg1 = (std::vector< MAF::IMediaPipelineFactoryPlugin * > *) 0 ;
  int arg2 ;
  std::vector< MAF::IMediaPipelineFactoryPlugin * > *arg3 = 0 ;
  ...
  try {
    std_vector_Sl_MAF_IMediaPipelineFactoryPlugin_Sm__Sg__SetRange(arg1,arg2,(std::vector< MAF::IMediaPipelineFactoryPlugin * > const &)*arg3);
  } catch(std::out_of_range &_e) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentOutOfRangeException, 0, (&_e)->what());
    return ;
  }
...
SWIGEXPORT unsigned int SWIGSTDCALL CSharp_maf_PluginArray_Contains(void * jarg1, void * jarg2) {
  ...
  temp2 = (MAF::IMediaPipelineFactoryPlugin *)jarg2;
  arg2 = (MAF::IMediaPipelineFactoryPlugin **)&temp2; 
  result = (bool)std_vector_Sl_MAF_IMediaPipelineFactoryPlugin_Sm__Sg__Contains(arg1,(MAF::IMediaPipelineFactoryPlugin *const &)*arg2);
  jresult = result; 
  return jresult;
}


SWIGEXPORT int SWIGSTDCALL CSharp_maf_PluginArray_IndexOf(void * jarg1, void * jarg2) {
  int jresult ;
  std::vector< MAF::IMediaPipelineFactoryPlugin * > *arg1 = (std::vector< MAF::IMediaPipelineFactoryPlugin * > *) 0 ;
  MAF::IMediaPipelineFactoryPlugin **arg2 = 0 ;
  MAF::IMediaPipelineFactoryPlugin *temp2 = 0 ;
  ...
  temp2 = (MAF::IMediaPipelineFactoryPlugin *)jarg2;
  arg2 = (MAF::IMediaPipelineFactoryPlugin **)&temp2; 
  result = (int)std_vector_Sl_MAF_IMediaPipelineFactoryPlugin_Sm__Sg__IndexOf(arg1,(MAF::IMediaPipelineFactoryPlugin *const &)*arg2);
  jresult = result; 
  return jresult;
}


SWIGEXPORT int SWIGSTDCALL CSharp_maf_PluginArray_LastIndexOf(void * jarg1, void * jarg2) {
  int jresult ;
  std::vector< MAF::IMediaPipelineFactoryPlugin * > *arg1 = (std::vector< MAF::IMediaPipelineFactoryPlugin * > *) 0 ;
  MAF::IMediaPipelineFactoryPlugin **arg2 = 0 ;
  MAF::IMediaPipelineFactoryPlugin *temp2 = 0 ;
  ...
  temp2 = (MAF::IMediaPipelineFactoryPlugin *)jarg2;
  arg2 = (MAF::IMediaPipelineFactoryPlugin **)&temp2; 
  result = (int)std_vector_Sl_MAF_IMediaPipelineFactoryPlugin_Sm__Sg__LastIndexOf(arg1,(MAF::IMediaPipelineFactoryPlugin *const &)*arg2);
  jresult = result; 
  return jresult;
}


SWIGEXPORT unsigned int SWIGSTDCALL CSharp_maf_PluginArray_Remove(void * jarg1, void * jarg2) {
  unsigned int jresult ;
  std::vector< MAF::IMediaPipelineFactoryPlugin * > *arg1 = (std::vector< MAF::IMediaPipelineFactoryPlugin * > *) 0 ;
  MAF::IMediaPipelineFactoryPlugin **arg2 = 0 ;
  MAF::IMediaPipelineFactoryPlugin *temp2 = 0 ;
  ...
  temp2 = (MAF::IMediaPipelineFactoryPlugin *)jarg2;
  arg2 = (MAF::IMediaPipelineFactoryPlugin **)&temp2; 
  result = (bool)std_vector_Sl_MAF_IMediaPipelineFactoryPlugin_Sm__Sg__Remove(arg1,(MAF::IMediaPipelineFactoryPlugin *const &)*arg2);
  jresult = result; 
  return jresult;
}


SWIGEXPORT void SWIGSTDCALL CSharp_maf_delete_PluginArray(void * jarg1) {
  std::vector< MAF::IMediaPipelineFactoryPlugin * > *arg1 = (std::vector< MAF::IMediaPipelineFactoryPlugin * > *) 0 ;
...
SWIGEXPORT void SWIGSTDCALL CSharp_maf_delete_IMediaPipelineFactoryPlugin(void * jarg1) {
  MAF::IMediaPipelineFactoryPlugin *arg1 = (MAF::IMediaPipelineFactoryPlugin *) 0 ;
  
  arg1 = (MAF::IMediaPipelineFactoryPlugin *)jarg1; 
  delete arg1;
}


SWIGEXPORT void * SWIGSTDCALL CSharp_maf_IMediaPipelineFactoryPlugin_createMediaPipeline(void * jarg1) {
  void * jresult ;
  MAF::IMediaPipelineFactoryPlugin *arg1 = (MAF::IMediaPipelineFactoryPlugin *) 0 ;
  MAF::IMediaPipeline *result = 0 ;
  
  arg1 = (MAF::IMediaPipelineFactoryPlugin *)jarg1; 
  result = (MAF::IMediaPipeline *)(arg1)->createMediaPipeline();
  jresult = (void *)result; 
  return jresult;
}
...
SWIGEXPORT void SWIGSTDCALL CSharp_maf_MediaPipelineFactory_plugins_set(void * jarg1, void * jarg2) {
  MAF::MediaPipelineFactory *arg1 = (MAF::MediaPipelineFactory *) 0 ;
  std::vector< MAF::IMediaPipelineFactoryPlugin * > *arg2 = (std::vector< MAF::IMediaPipelineFactoryPlugin * > *) 0 ;
...
SWIGEXPORT void * SWIGSTDCALL CSharp_maf_MediaPipelineFactory_plugins_get(void * jarg1) {
  void * jresult ;
  MAF::MediaPipelineFactory *arg1 = (MAF::MediaPipelineFactory *) 0 ;
  std::vector< MAF::IMediaPipelineFactoryPlugin * > *result = 0 ;
  
  arg1 = (MAF::MediaPipelineFactory *)jarg1; 
  result = (std::vector< MAF::IMediaPipelineFactoryPlugin * > *)& ((arg1)->plugins);
  jresult = (void *)result; 
  return jresult;
}


SWIGEXPORT void SWIGSTDCALL CSharp_maf_MediaPipelineFactory_loadPluginsDir__SWIG_0(void * jarg1, char * jarg2) {
  MAF::MediaPipelineFactory *arg1 = (MAF::MediaPipelineFactory *) 0 ;
  char *arg2 = (char *) 0 ;
  
  arg1 = (MAF::MediaPipelineFactory *)jarg1; 
  arg2 = (char *)jarg2; 
  (arg1)->loadPluginsDir(arg2);
}


SWIGEXPORT void SWIGSTDCALL CSharp_maf_MediaPipelineFactory_loadPluginsDir__SWIG_1(void * jarg1) {
  MAF::MediaPipelineFactory *arg1 = (MAF::MediaPipelineFactory *) 0 ;
...
SWIGEXPORT void SWIGSTDCALL CSharp_maf_MediaPipelineFactory_loadPluginDL(void * jarg1, char * jarg2) {
  MAF::MediaPipelineFactory *arg1 = (MAF::MediaPipelineFactory *) 0 ;
  char *arg2 = (char *) 0 ;
  
  arg1 = (MAF::MediaPipelineFactory *)jarg1; 
  arg2 = (char *)jarg2; 
  (arg1)->loadPluginDL(arg2);
}
...
SWIGEXPORT const char * SWIGSTDCALL CSharp_maf_fpFnName_get() {
  const char * jresult ;
  std::string *result = 0 ;
  
  result = (std::string *) &MAF::fpFnName;
  jresult = SWIG_csharp_string_callback(result->c_str()); 
  return jresult;
}
